...
namespace Shotake
{
    ...
    class StageGameManager : MonobehaviourSingletone<StageGameManager>
    {
        ...
        //[SerializeField] StageSceneState m_state;
        ...
        //[SerializeField] StageSceneState m_stageState;

        public SK_Player Player => m_player;
        //public StageSceneState PlayerState => m_state;
       ...
       // public StageSceneState StageState => m_stageState;
        ...
        private IEnumerator Start()
        {
            ...
            //if (m_state.HP <= 0)
            //{
            //    var failPanel = UIObjectManager.Instance.GetObject("FailPanel");
            ...
            //else
            {
                var clearPanel = UIObjectManager.Instance.GetObject("ClearPanel");
                TimeManager.Instance.TimeScale = 0;
